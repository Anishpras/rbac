...
export class RBACManager {
  ...
  public middleware(options: {
    getUserRoles: (req: any) => Role[] | Promise<Role[]>;
    resource: Resource | ((req: any) => Resource);
    permission: Permission | ((req: any) => Permission);
    ...
    return async (req: any, res: any, next: any) => {
      try {
        ...
        const permission = typeof options.permission === 'function'
